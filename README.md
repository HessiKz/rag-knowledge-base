...
> Retrieval-Augmented Generation pipeline demo: chunking, embedding, vector search visualization, and citation panel.

**Category:** AI / LLM  
**Built with:** FastAPI, LangChain, pgvector, React, Vite  
...
👉 https://HessiKz.github.io/rag-knowledge-base/

## Features

- Interactive, client-side visualisation of the AI / LLM concept
...
git clone https://github.com/HessiKz/rag-knowledge-base.git
